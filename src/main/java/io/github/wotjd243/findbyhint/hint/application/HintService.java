...
public class HintService {
    ...
    protected Hint findByHunterIdAndTreasureId(HunterId hunterId, Long treasureId) {
    ...
    public List<Long> getHintTargetPointIds(final HunterId hunterId, final Long treasureId){
        // 힌트객체 가져오기
        final Hint hint  = findByHunterIdAndTreasureId(hunterId,treasureId);
        //TODO.1 해당 힌트에 대한 타겟 포인트의 집합  (타겟포인트들의 집합을 구하는 법)
        return hint.getBringTargetPointIds();
